...
while True:
    ...
    # Slots.
        ...
        # If the user choose slots 
        if game == "slots":

            # The games cost   a cetain amount.
            slots_price = 50
            ...
            #There are three slots on the slot machine
            slot_1 = str(random.randint(1,3))
            slot_2 = str(random.randint(1,3))
            slot_3 = str(random.randint(1,3))

            # This is the full spread of the slots
            slot_spread = slot_1 + slot_2 + slot_3
